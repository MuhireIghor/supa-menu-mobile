    ...
    return (
        <SafeAreaView className='w-full h-full px-6 flex flex-col gap-y-2' >
            ...
            <View className='flex flex-col pb-2'>
                ...
                <CustomField icon={<FontAwesome5 color={"#a6adc0"} name='envelope' size={20} />} handleChange={(e: any) => setForm({ ...form, email: e })} value={form.email} placeHolder='Your Email' secureTextEntry={false} keyboardType='email-address' />
                <CustomField icon={<FontAwesome5 color={"#a6adc0"} name='envelope' size={20} />} handleChange={(e: any) => setForm({ ...form, password: e })} value={form.password} placeHolder='Your Password' secureTextEntry={true} keyboardType='default' />
            </View>
            <CustomButton text='Proceed' textStyles='text-white text-center text-lg font-semibold' otherStyle="font-medium  bg-primary rounded-xl w-full" onPress={() => { }} />
